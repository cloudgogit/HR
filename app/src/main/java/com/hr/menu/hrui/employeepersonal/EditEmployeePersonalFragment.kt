package com.hr.menu.hrui.employeepersonal
...
import kotlinx.android.synthetic.main.fragment_add_new_employee_personal.ed_dob
import kotlinx.android.synthetic.main.fragment_add_new_employee_personal.ed_passport_expiredate
import kotlinx.android.synthetic.main.fragment_add_new_employee_personal.ed_passport_issuedate
import kotlinx.android.synthetic.main.fragment_add_new_employee_personal.emp_next
import kotlinx.android.synthetic.main.fragment_add_new_employee_personal.et_children
import kotlinx.android.synthetic.main.fragment_add_new_employee_personal.et_current_address
import kotlinx.android.synthetic.main.fragment_add_new_employee_personal.et_email_id
import kotlinx.android.synthetic.main.fragment_add_new_employee_personal.et_emergency_contactno
import kotlinx.android.synthetic.main.fragment_add_new_employee_personal.et_emergency_name
import kotlinx.android.synthetic.main.fragment_add_new_employee_personal.et_emergency_relationship
import kotlinx.android.synthetic.main.fragment_add_new_employee_personal.et_emp_name
import kotlinx.android.synthetic.main.fragment_add_new_employee_personal.et_gender
import kotlinx.android.synthetic.main.fragment_add_new_employee_personal.et_ic_address
import kotlinx.android.synthetic.main.fragment_add_new_employee_personal.et_ico
import kotlinx.android.synthetic.main.fragment_add_new_employee_personal.et_marital_status
import kotlinx.android.synthetic.main.fragment_add_new_employee_personal.et_passportno
import kotlinx.android.synthetic.main.fragment_add_new_employee_personal.et_physical_challenge
import kotlinx.android.synthetic.main.fragment_add_new_employee_personal.et_race
import kotlinx.android.synthetic.main.fragment_add_new_employee_personal.et_religion
import kotlinx.android.synthetic.main.fragment_add_new_employee_personal.et_spouse_employement
import kotlinx.android.synthetic.main.fragment_add_new_employee_personal.et_spouse_icno
import kotlinx.android.synthetic.main.fragment_add_new_employee_personal.et_spouse_name
import kotlinx.android.synthetic.main.fragment_add_new_employee_personal.lay_heading
import kotlinx.android.synthetic.main.fragment_add_new_employee_personal.menu_click
import kotlinx.android.synthetic.main.fragment_edit_employee_personal.*
import org.koin.androidx.viewmodel.ext.android.viewModel
import java.util.*

class EditEmployeePersonalFragment : Fragment(), DatePickerDialog.OnDateSetListener,
    LifecycleObserver {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_edit_employee_personal, container, false)
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        edit_radio_group.setOnCheckedChangeListener(RadioGroup.OnCheckedChangeListener { group, checkedId ->
    ...
    private fun setEmployeeinfo() {
        employeeAddPersonalViewViewModel.reqEditEmployeePersonalInfo(
            ...
            et_children.setText(it.res[0].children)
                if (it.res[0].hraccess.equals("yes")) {
                    need_access_edit.isChecked = true
                    no_need.isChecked = false
                }
                else{
                    no_need.isChecked = true
                    need_access_edit.isChecked = false
                }
    ...
    private fun addEmployeePersonlInfo() {
        ...
        employeeAddPersonalViewViewModel.reqAddEmployeePersonalInfo(
            RequestEmployeePersonalInfo(
            token =  SessionSave.getSession("user_login_token",requireContext()),
            empname = et_emp_name.text.toString(),
            dob = ed_dob.text.toString(),
            icno = et_ico.text.toString(),
