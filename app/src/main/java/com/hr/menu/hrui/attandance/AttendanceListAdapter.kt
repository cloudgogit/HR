...
class AttendanceListAdapter(val attendanceEvent: AttendanceEvent,
    upComingList: List<ResponseAttendance.Re>
) :
    RecyclerView.Adapter<AttendanceListAdapter.CategoryHolder>() {
